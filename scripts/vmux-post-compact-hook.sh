#!/usr/bin/env bash
#
# vmux-post-compact-hook.sh — Claude Code PostCompact hook
#
# Fires after Claude finishes auto-compaction. Posts a short
# "Compaction complete." callout to the relay so the web UI renders the
# faded system bubble and TTSes the announcement directly through
# Kokoro (bypassing Claude — this is a system event).
