...
const AUDIO_SPEED_MAX = 10.0; // max speed multiplier at full amplitude
const AUDIO_LERP_UP = 0.8; // how fast multiplier rises with audio
const AUDIO_LERP_DOWN = 0.25; // how fast multiplier decays back to 1
