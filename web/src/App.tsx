  ...
  return (
    <div style={{
      ...
      <ol style={{ margin: '0.4rem 0 0.4rem 1.2rem', padding: 0 }}>
        <li>Open <code style={{ userSelect: 'all' }}>chrome://flags/#unsafely-treat-insecure-origin-as-secure</code> in Chrome</li>
        <li>Add this URL to the allowlist:&nbsp;
  ...
  return (
    <>
      ...
      <div className={styles.Layout}>
        ...
        {relay.connectedSessionId && livekit.token && livekit.url && navigator.mediaDevices && (
